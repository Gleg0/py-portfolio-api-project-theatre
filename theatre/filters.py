...
class PerformanceFilter(django_filters.FilterSet):
    ...
    play_title = django_filters.CharFilter(
        field_name="play__title", lookup_expr="icontains"
    )
    genre = django_filters.CharFilter(
        field_name="play__genres__name", lookup_expr="icontains"
    )
    actor = django_filters.CharFilter(
        field_name="play__actors__last_name", lookup_expr="icontains"
    )
...
class PlayFilter(django_filters.FilterSet):
    ...
    actor = django_filters.CharFilter(
        field_name="actors__last_name", lookup_expr="icontains"
    )
